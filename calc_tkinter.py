...
#iniciando la instancia raiz de la app
root = Tk()
#dandole titulo a la app
...
#creo las funciones de la calculadora
def get_numbers(n):
    global i
    display.insert(i, n)
    i+=1
...
#creamos los botones numericos de la calculadora
...
#creo los botones de operaciones de la calculadora
